...
$recupData =$conn->prepare('SELECT * FROM film WHERE Id_Film =?');
$recupData->execute([
  'Id_Film' => $id
]);

$infoFilm = $recupData->fetch(PDO::FETCH_ASSOC);
*/
?>

<h1 class="d-flex justify-content-center mt-5">EN TRAVAUX</h1>

<div class="d-flex justify-content-center">
<img src="../../cinemet/asset/img/travaux.png" height="500px">
</div>
   
   <!-- <form method="POST" action="../../cinemet/traitement/update.php" class="d-flex justify-content-center">
       <div class="my-5 w-75">
          <div class="mb-3 visually-hidden">
            <label for="id" class="form-label">Id du film</label>
            <input type="hidden" class="form-control" id="id" name="Id_Film" value="<?= $id ?>">
